...
class AppColors {
  ...
  static const Color friendOn = Color(0xff7FDBA4);
  static const Color friendPlus = Color(0xff85E8AD);
  //Alone
  static const Color aloneOff = Color(0xffBBEAF0);
  static const Color aloneOn = Color(0xff88DFEB);
  static const Color alonePlus = Color(0xff8EE8F4);
  //월별보기 달성률
  static const Color month0 = Color(0xffF6F6F6);
  static const Color month1 = Color(0xffE4F6F9);
  static const Color month2 = Color(0xffB0F1FA);
  static const Color month3 = Color(0xff61DAEA);
  static const Color month4 = Color(0xff00B0C7);
  static const Color month5 = Color(0xff008496);
  //Button Colors
